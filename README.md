# IC50-Forge: A Workflow for IC50 Prediction

1) Objective:
This project is a self-directed study to build and validate a machine-learning model for predicting IC50 values. 
